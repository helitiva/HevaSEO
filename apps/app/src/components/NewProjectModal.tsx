        ...
        return (
          <form onSubmit={submit} className="space-y-4">
            ...
            <div className="flex items-center justify-end gap-2 pt-1">
              ...
              <button type="submit" disabled={!cleanDomain(domain)} className="inline-flex items-center gap-1.5 rounded-lg bg-primary px-3.5 py-2 text-sm font-bold text-primary-foreground transition hover:bg-primary/90 disabled:opacity-50"><i className="ph-bold ph-check" /> {submitLabel}</button>
            </div>
          </form>
        );
      }}
