...
// inc-E28 — admin approves / requests changes on a submitted deliverable (records the real verdict; the
// order state move stays advance_order, called alongside from the client). Admin-gated + idempotent in fn.
