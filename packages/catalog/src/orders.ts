  ...
  backlink: {
    ...
    packageGroups: [
      ...
      },
      {
        ...
        icon: 'ph-megaphone',
        packages: [
          { id: 'pr', name: 'PR feature', icon: 'ph-megaphone', hue: 'rose', price: 120, priceLabel: 'from $120', sla: 'By scope', summary: 'International press coverage', features: ['Published on international news sites', 'Sites & cost proposed to your budget & niche', '~100% indexed', 'A link to the published article'] },
        ],
      },
    ],
